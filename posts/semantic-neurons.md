...
![A plot graph showing how well our algorithm works.](functiongen/01_naivesearch.png)
...
![A plot graph showing how well our algorithm works.](functiongen/03_weights_evo_and_history.png)
...
![A plot graph](functiongen/04_10k-10k_randomEvo.png)
...
![A plot graph](functiongen/05_10-10_weightedEvo.png)
![A pie graph showing relative constructive utilization of different instructions..](FunctionGen/InstructionSetWeighting.PNG)
...
![A graph showing the true function alongside the calculated approximation.](functiongen/07_Graph%20-%20plotting%20function%20against%20approx.png)
...
![A final plot of our graph.](functiongen/output_final.png)
